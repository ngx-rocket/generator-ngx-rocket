...
* `translations/[lang].json`: the string to translate here.
* `app/@i18n/i18n.service.ts`: load the language here.
* `app/@i18n/i18n-locales.ts`: add the new language name here.
* `environments/environment[.prod].ts`: supported-languages
